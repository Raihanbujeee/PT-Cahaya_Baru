...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $products = [
            ...
            [
                'name' => 'Cat Tembok Eksterior Biru 5Kg',
                'category' => 'Cat Tembok',
                'brand' => 'Avian',
            ...
            [
                'name' => 'Keramik Dinding 20x40 Motif',
                'category' => 'Keramik',
                'brand' => 'Arwana',
                'purchase_price' => 55000,
                'selling_price' => 65000,
            ...
            [
                'name' => 'Kabel Listrik NYA 1x2.5mm 100m',
                'category' => 'Kabel',
                'brand' => 'Supreme',
            ...
            [
                'name' => 'Genteng Metal Berpasir Hitam',
                'category' => 'Genteng',
                'brand' => 'Sakura',
                'purchase_price' => 35000,
                'selling_price' => 45000,
        ...
        $installationServices = [
            ...
            ['product_name' => 'Paku Payung 2 Inch', 'name' => 'Jasa Pemasangan Asbes/Seng', 'price' => 15000, 'description' => 'Jasa pemasangan atap seng atau asbes menggunakan paku payung per meter persegi'],
            ['product_name' => 'Genteng Tanah Liat Sokka', 'name' => 'Pemasangan Genteng', 'price' => 25000, 'description' => 'Jasa pemasangan genteng tanah liat per meter persegi'],
            ['product_name' => 'Batu Bata Merah Standard', 'name' => 'Pemasangan Batu Bata', 'price' => 45000, 'description' => 'Jasa pasang batu bata merah per meter persegi'],
            ['product_name' => 'Cat Tembok Eksterior Biru 5Kg', 'name' => 'Pengecatan Eksterior', 'price' => 18000, 'description' => 'Jasa pengecatan tembok luar / eksterior per meter persegi'],
            ['product_name' => 'Pipa PVC 1 Inch AW', 'name' => 'Pemasangan Saluran Air Besar', 'price' => 20000, 'description' => 'Jasa instalasi pipa saluran utama air bersih/kotor per titik'],
            ['product_name' => 'Keramik Dinding 20x40 Motif', 'name' => 'Pemasangan Keramik Dinding', 'price' => 40000, 'description' => 'Jasa pemasangan keramik dinding per meter persegi'],
            ['product_name' => 'Besi Siku 40x40 6M', 'name' => 'Pengelasan Rangka Besi', 'price' => 60000, 'description' => 'Jasa pemotongan dan pengelasan besi siku per meter panjang'],
            ['product_name' => 'Paku Beton 5cm', 'name' => 'Pemasangan Paku Tembok', 'price' => 5000, 'description' => 'Jasa pemasangan paku beton pada tembok keras per titik'],
            ['product_name' => 'Kayu Kaso 5x7 4M', 'name' => 'Pembuatan Rangka Kayu', 'price' => 30000, 'description' => 'Jasa pembuatan rangka kayu atap atau partisi per meter persegi'],
            ['product_name' => 'Kabel Listrik NYA 1x2.5mm 100m', 'name' => 'Penarikan Kabel Instalasi', 'price' => 15000, 'description' => 'Jasa tarik kabel instalasi di dalam pipa conduit per meter'],
            ['product_name' => 'Semen Putih 40Kg', 'name' => 'Pekerjaan Plamir/Acian', 'price' => 25000, 'description' => 'Jasa plamir tembok atau acian halus per meter persegi'],
            ['product_name' => 'Genteng Metal Berpasir Hitam', 'name' => 'Pemasangan Genteng Metal', 'price' => 30000, 'description' => 'Jasa pemasangan genteng metal pada rangka baja ringan per meter persegi'],
            ['product_name' => 'Batako Press Standard', 'name' => 'Pemasangan Batako', 'price' => 35000, 'description' => 'Jasa pasang dinding batako per meter persegi'],
            ['product_name' => 'Cat Kayu & Besi Hitam 1Kg', 'name' => 'Pengecatan Besi/Kayu', 'price' => 20000, 'description' => 'Jasa pengecatan rangka besi atau kayu per meter'],
            ['product_name' => 'Knie PVC 1/2 Inch', 'name' => 'Pemasangan Fitting Pipa', 'price' => 10000, 'description' => 'Jasa pasang fitting pipa / keni penyambung per titik'],
            ['product_name' => 'Keramik Kamar Mandi Anti Slip 20x20', 'name' => 'Pemasangan Keramik Kamar Mandi', 'price' => 45000, 'description' => 'Jasa pasang keramik anti slip termasuk pembuatan kemiringan air per meter persegi'],
            ['product_name' => 'Besi Hollow 4x4 6M', 'name' => 'Pembuatan Rangka Kanopi', 'price' => 75000, 'description' => 'Jasa las rangka kanopi besi hollow per meter persegi'],
            ['product_name' => 'Engsel Pintu 4 Inch', 'name' => 'Pemasangan Engsel & Pintu', 'price' => 50000, 'description' => 'Jasa pemasangan engsel sekaligus stel pintu per daun pintu'],
            ['product_name' => 'Kayu Balok 8x12 4M', 'name' => 'Pemasangan Kusen/Struktur', 'price' => 80000, 'description' => 'Jasa potong, serut, dan pasang balok struktur per batang'],
            ['product_name' => 'Saklar Engkel 1 Gang', 'name' => 'Pemasangan Saklar Listrik', 'price' => 25000, 'description' => 'Jasa pemasangan saklar tunggal termasuk sambung kabel per titik'],
        ];
